...
const ChatPage: React.FC = () => {
    ...
    const handleSendMessage = () => {
        ...
        const inappropriateWords = [
            ...
            'putangina', 'tanga', 'gago', 'bobo', 'pota', 'puta', 'ulol', 'kantot', 'i love you', 'labu', 'lab u',
            'bogo', 'bugo', 'buang', 'amaw', 'giatay', 'ataya', 'yawa', 'pesteng yawa', 'bubu', 'bubo', 'bobo',
            'piste', 'pisti', 'piskot', 'animal', 'bilat', 'bilatsing', 'burat', 'lubot', 'bobu', 'erset', 'shida',
            'kiki', 'kiking', 'titi', 'otin', 'toti', 'bayot', 'tomboy', 'talong', 'itlog', 'sheda', 'pashnia',
            'kantot', 'iyot', 'iyoton', 'iyota', 'hilas', 'hambog', 'way ayo', 'walay ayo', 'pasnia', 'warka',
            'way batasan', 'bastos', 'demonyo', 'yawa ka', 'piste ka', 'giatay ka', 'amaw ka', 'bubu',
