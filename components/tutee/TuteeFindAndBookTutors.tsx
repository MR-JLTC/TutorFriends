                ...
                return (
                  <div key={t.user_id} className="group relative bg-white border border-slate-200 rounded-2xl p-4 sm:p-4 shadow-sm hover:shadow-xl hover:border-transparent transition-all duration-200 flex flex-col h-full overflow-hidden z-0">
                    ...
                    <div className="flex flex-col items-center text-center sm:hidden flex-1">
                      ...
                      {/* Name */}
                      <h3 className="font-bold text-base text-slate-800 group-hover:text-white transition-colors duration-300 mb-1">{t.name}</h3>

                      {/* University */}
                      <div className="flex items-center justify-center gap-1.5 mb-3">
                        <svg className="w-3.5 h-3.5 text-sky-500 group-hover:text-sky-200 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span className="text-xs text-slate-600 group-hover:text-sky-50 transition-colors duration-300">{t.university_name || 'N/A'}</span>
                      </div>
                    ...
                    <div className="hidden sm:flex items-start gap-3 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="font-semibold text-xs sm:text-sm md:text-base text-slate-800 group-hover:text-white transition-colors duration-300 truncate">{t.name}</div>
                        <div className="text-[10px] sm:text-xs md:text-sm text-slate-500 group-hover:text-sky-50 transition-colors duration-300 truncate">{t.university_name || 'N/A'}</div>
                            ...
                            {(() => {
                              ...
                              return (
                                <>
                                  ...
                                  <span className="text-[10px] sm:text-xs md:text-sm text-slate-600 group-hover:text-white/90 transition-colors duration-300 truncate">
                                    {rating > 0 ? rating.toFixed(1) : 'No ratings'}
                                    {totalRatings > 0 ? ` (${totalRatings})` : ''}
                                  </span>
                                </>
