...
import { Bell, Calendar, Clock, User, BookOpen, Info, AlertCircle, CheckCircle2, XCircle, Star } from 'lucide-react';
...
const TuteeMyBookings: React.FC = () => {
  ...
  return (
    <div className="space-y-7 sm:space-y-4 md:space-y-6">
